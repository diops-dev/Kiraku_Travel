...
export default {
  ...
  visuels: {
    'CL-01': [
      { ico: 'bed', lbl: 'Hôtels à Tokyo, ryokan et deux nuits en temple' },
      { ico: 'meal', lbl: 'Repas selon le programme du jour' },
      { ico: 'guide', lbl: 'Guide francophone permanent' },
      { ico: 'ticket', lbl: 'Japan Rail Pass quatorze jours' },
      { ico: 'market', lbl: 'Marché de Toyosu au petit matin' },
      { ico: 'flag', lbl: 'Atelier de calligraphie shodo' },
      { ico: 'temple', lbl: 'Cérémonie du thé à Kanazawa' },
      { ico: 'luggage', lbl: 'Portage des bagages, Tokyo à la vallée' },
    ],
    'CL-02': [
      { ico: 'bed', lbl: 'Temple shukubo, ryokan et minshuku' },
      { ico: 'meal', lbl: 'Repas selon le programme du jour' },
      { ico: 'guide', lbl: 'Guide francophone permanent' },
      { ico: 'temple', lbl: 'Rituel de purification à Ise' },
      { ico: 'temple', lbl: 'Offices du matin avec les moines' },
      { ico: 'mountain', lbl: 'Étapes marchées du Kumano Kodo' },
      { ico: 'luggage', lbl: 'Bagages transférés entre les étapes' },
      { ico: 'ticket', lbl: 'Bâton de pèlerin et carnet shuin' },
    ],
    'CL-03': [
      { ico: 'bed', lbl: 'Ryokan à Kyoto, hôtel à Okinawa' },
      { ico: 'meal', lbl: 'Repas selon le programme du jour' },
      { ico: 'guide', lbl: 'Guide francophone, puis accompagnateur local' },
      { ico: 'train', lbl: 'Vol intérieur et transferts en bateau' },
      { ico: 'market', lbl: 'Sorties snorkeling sur les récifs' },
      { ico: 'onsen', lbl: 'Accès aux onsen des hébergements' },
      { ico: 'temple', lbl: 'Séances de yoga au lever du jour' },
    ],
    'CL-04': [
      { ico: 'bed', lbl: 'Hôtels à Tokyo et Kyoto, une nuit en ryokan' },
      { ico: 'meal', lbl: 'Repas selon le programme du jour' },
      { ico: 'guide', lbl: 'Guide francophone permanent' },
      { ico: 'ticket', lbl: 'Japan Rail Pass sept jours' },
      { ico: 'temple', lbl: 'Château de Nijo, Kinkakuji, Fushimi Inari' },
      { ico: 'flag', lbl: 'Kimono et cérémonie du thé à Kyoto' },
      { ico: 'luggage', lbl: 'Transfert des bagages, Tokyo à Kyoto' },
    ],
    'CL-05': [
      { ico: 'bed', lbl: 'Machiya, ryokan et minshuku' },
      { ico: 'meal', lbl: 'Repas selon le programme du jour' },
      { ico: 'guide', lbl: 'Guide francophone, pratiquant des arts martiaux' },
      { ico: 'flag', lbl: 'Deux initiations en dojo, kendo et kyudo' },
      { ico: 'temple', lbl: "Démonstration privée d'iaido" },
      { ico: 'market', lbl: 'Visite d’un forgeron de sabres' },
      { ico: 'train', lbl: 'Trains et bus sur tout le parcours' },
    ],
    'CL-06': [
      { ico: 'bed', lbl: 'Hôtels, ryokan et ferme à Hokkaido' },
      { ico: 'meal', lbl: 'Repas selon le programme du jour' },
      { ico: 'guide', lbl: 'Guide francophone permanent' },
      { ico: 'flag', lbl: 'Cinq ateliers de cuisine japonaise' },
      { ico: 'market', lbl: 'Marchés aux poissons et brasserie de saké' },
      { ico: 'train', lbl: 'Ferry pour Hokkaido inclus' },
      { ico: 'luggage', lbl: 'Portage des bagages entre les étapes' },
    ],
    'CL-07': [
      { ico: 'bed', lbl: 'Hôtels et deux nuits à Shirakawa-go' },
      { ico: 'meal', lbl: 'Repas selon le programme du jour' },
      { ico: 'guide', lbl: 'Guide francophone permanent' },
      { ico: 'ticket', lbl: 'Musée et parc Ghibli' },
      { ico: 'flag', lbl: 'Atelier de dessin manga' },
      { ico: 'market', lbl: 'Journées libres à Akihabara et Nakano' },
      { ico: 'luggage', lbl: 'Portage des bagages entre les étapes' },
    ],
    'CL-08': [
      { ico: 'bed', lbl: 'Hôtels, ryokan et trois nuits à Yakushima' },
      { ico: 'meal', lbl: 'Repas selon le programme du jour' },
      { ico: 'guide', lbl: 'Guide francophone, puis guide naturaliste' },
      { ico: 'mountain', lbl: 'Forêt primaire jusqu’au cèdre Jomon Sugi' },
      { ico: 'onsen', lbl: 'Onsen de bord de mer et de montagne' },
      { ico: 'train', lbl: 'Vol intérieur et ferry pour Yakushima' },
      { ico: 'luggage', lbl: 'Portage des bagages entre les étapes' },
    ],
    'CL-09': [
  ...
  // Grille "non inclus", identique sur tous les circuits (memes exclusions de base)
  exclusVisuels: [
    { ico: 'plane', lbl: 'Vols internationaux' },
    { ico: 'shield', lbl: 'Assurance voyage' },
    { ico: 'wallet', lbl: 'Dépenses personnelles et souvenirs' },
    { ico: 'passport', lbl: 'Frais de passeport' },
    { ico: 'bed', lbl: 'Supplément chambre individuelle' },
  ],
};
